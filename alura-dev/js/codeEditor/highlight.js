...
(function () {
  var high = (function () {
    ...
    }(); "object" == typeof exports && "undefined" != typeof module && (module.exports = hljs); hljs.registerLanguage("sql", (() => {
  ...
  const highButton = document.querySelector(".m_code_highlights");
  let editor = document.getElementById("editor-text");
  const code = document.querySelector("[data-code-preview]");
  ...
  highButton.addEventListener("click", function () {
    ...
    if (langMode) {
      //Troca entre os elementos textarea e code
      editor.style.display = "none";
      code.style.display = "inline-block";
      code.textContent = text;

      high.highlightElement(code);
      ...
      this.textContent = "Visualizar com o highlight";
    }
  });;
})();